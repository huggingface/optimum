...
- [Intel OpenVINO](https://github.com/openvinotoolkit/openvino/) - OpenVINO runtime for models inference and Neural Network Compression Framework for optimization during training.
