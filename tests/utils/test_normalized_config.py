...
class NormalizedConfigManagerTest(unittest.TestCase):
    def test_mobilevit_is_registered(self):
        config_class = NormalizedConfigManager.get_normalized_config_class("mobilevit")
        self.assertIs(config_class, NormalizedVisionConfig)

    def test_mobilevit_normalizes_expected_attributes(self):
        config = MobileViTConfig()
        normalized_config_class = NormalizedConfigManager.get_normalized_config_class("mobilevit")
