...
class NormalizedConfigManagerTest(unittest.TestCase):
    def test_convnext_is_registered(self):
        config_class = NormalizedConfigManager.get_normalized_config_class("convnext")
        self.assertIs(config_class, NormalizedVisionConfig)

    def test_convnext_normalizes_expected_attributes(self):
        config = ConvNextConfig()
        normalized_config_class = NormalizedConfigManager.get_normalized_config_class("convnext")
