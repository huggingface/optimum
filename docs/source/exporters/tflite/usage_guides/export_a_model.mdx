...
# Export a model to ONNX with optimum.exporters.tflite
...
The Optimum ONNX export can be used through Optimum command-line. As only static input shapes is supported for now, they need to be precised during the export.
