...
Each configuration comes with a set of _tasks_ that enable you to export models for different types of tasks. You can
check the list of supported tasks for both PyTorch and TensorFlow [here](/exporters/task_manager).

For each configuration, you can find the list of supported tasks via the
