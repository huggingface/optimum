...
You can now use this feature in HuggingFace `optimum` together with `transformers` and use it for major models in the HuggingFace ecosystem.
...
Let us know by opening an issue in `optimum` if you want more models to be supported, or check out the contribution guideline if you want to add it by yoursefl!
