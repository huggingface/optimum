...
You can find more examples in the [documentation](https://huggingface.co/docs/optimum/main/intel/ipex/inference) and in the [examples](https://github.com/huggingface/optimum-intel/tree/main/notebooks/ipex).
