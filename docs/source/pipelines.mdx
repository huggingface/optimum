...
Below you can find two examples on how you could [~`ORTOptimizer`] and [`~onnxruntime.ORTQuantizer`] to optimize/quantize your model and use it for inference afterwards.

### Quantizing with [`~onnxruntime.ORTQuantizer`]
