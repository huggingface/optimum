...
Model configuration classes in 🤗 Transformers are not standardized. Altough they provide an `attribute_map` attribute
...
TODO: it can be used as is wwith with_args
