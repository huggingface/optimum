...
We have tested three common models which have decoding process, they are: `GPT2` / `T5-small` / `M2M100-418M`, and the benchmark was run on a versatile Tesla T4 GPU (more environment details at the end of this section).

Here are some performance results running with `CUDAExecutionProvider` when IOBinding has been turned on. We haved tested sequence length from 8 to 512:


<table><tr>
<td>
  <p align="center">
    <img alt="GPT2" src="../../assets/onnxruntime/t4_res_ort_gpt2.png" width="300">
    <br>
...
<td>
  <p align="center">
    <img alt="T5-small" src="../../assets/onnxruntime/t4_res_ort_t5_s.png" width="300">
    <br>
...
<td>
  <p align="center">
    <img alt="M2M100-418M" src="../../assets/onnxruntime/t4_res_ort_m2m100_418m.png" width="300">
    <br>
...
And here is a summary for the saving time while using ONNX Runtime compared with PyTorch
...
Note that previous experiments are run with __vanilla ONNX__ models exported directly from the exporter. If you are interested in __further acceleration__, you can optimize the graph with `ORTOptimizer` and convert your model to FP16 if you have a GPU with mixed precision capabilities.
