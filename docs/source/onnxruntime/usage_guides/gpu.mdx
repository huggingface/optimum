...
<td>
  <p align="center">
    <img alt="GPT2" src="../../assets/onnxruntime/t4_res_ort_gpt2.png" width="450">
    <br>
...
<td>
  <p align="center">
    <img alt="T5-small" src="../../assets/onnxruntime/t4_res_ort_t5_s.png" width="450">
    <br>
...
<td>
  <p align="center">
    <img alt="M2M100-418M" src="../../assets/onnxruntime/t4_res_ort_m2m100_418m.png" width="450">
    <br>
...
And here is a summary for the saving time under different sequence length (from 8 to 512) while using ONNX Runtime compared with PyTorch:

<table><tr>
<td>
  <p align="center">
    <img alt="seq32" src="../../assets/onnxruntime/inference_models_32.png" width="450">
    <br>
...
<td>
  <p align="center">
    <img alt="seq128" src="../../assets/onnxruntime/inference_models_128.png" width="450">
    <br>
