...
__shorter latency, larger throughput, and larger maximum batch size__ while training large transformers models.
...
Check out more detailed [example scripts](https://github.com/huggingface/optimum) in the optimum repository.
...
+training_args =  ORTTrainingArguments(
    ...
    weight_decay=0.01,
    logging_dir=tmp_dir,
    optim="adamw_ort_fused",  # Fused Adam optimizer
)
```
