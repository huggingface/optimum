...
## Dynmaic Quantization example 

The `ORTQuantizer` class can be used to dynmaically quantize your onnx model. Below you will find an easy end-to-end example on how to dynamically quantize [distilbert-base-uncased-finetuned-sst-2-english](https://huggingface.co/distilbert-base-uncased-finetuned-sst-2-english).
