...
# now trace the whole pipeline
text_encoder_config = CLIPTextConfig.from_pretrained(model_name, subfolder="text_encoder")
...
#print(traced_pipeline.scheduler.step_plms.code)

print("Saving...")
torch.jit.save(traced_pipeline, f"traced_sd_{device}.pt")
