...
from ..pipelines.diffusers.pipeline_stable_diffusion_panorama import StableDiffusionPanoramaPipelineMixin
...
@add_end_docstrings(ONNX_MODEL_END_DOCSTRING)
class ORTStableDiffusionPanoramaPipeline(ORTStableDiffusionPipelineBase, StableDiffusionPanoramaPipelineMixin):
    def __call__(self, *args, **kwargs):
        return StableDiffusionPanoramaPipelineMixin.__call__(self, *args, **kwargs)
