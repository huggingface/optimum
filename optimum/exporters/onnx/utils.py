...
def get_encoder_decoder_models_for_export(
    ...
    decoder_onnx_config = config.with_behavior("decoder", use_past=False, use_present_in_outputs=config.use_past)
...
def get_decoder_models_for_export(
    ...
    onnx_config = config.__class__(
        model.config, task=config.task, use_past_in_inputs=False, use_present_in_outputs=config.use_past
    )
